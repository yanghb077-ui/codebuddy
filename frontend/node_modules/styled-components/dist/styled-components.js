(function (global, factory) {
    ...
    ***************************************************************************** */
    ...
    var removeGlobalStyleTag = function (componentId) {
        if (typeof document === 'undefined')
            return;
        var styleTags = document.querySelectorAll("style[data-styled-global=\"".concat(componentId, "\"]"));
    ...
    function createGlobalStyle(strings) {
        ...
        var GlobalStyleComponent = function (props) {
            ...
            if (!IS_RSC) {
                ...
                var shouldRemoveRef_1 = React.useRef(true);
                React.useLayoutEffect(function () {
                    // Signal that this component is mounted and styles should stay
                    shouldRemoveRef_1.current = false;
                    return function () {
                        // Mark that we're in cleanup
                        shouldRemoveRef_1.current = true;
            ...
            if (IS_RSC) {
                ...
                if (css_1) {
                    ...
                    var href = "".concat(styledComponentId, "-").concat(instance);
